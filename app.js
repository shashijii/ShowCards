...
function createVideoCard(session) {
    return new builder.VideoCard(session)
        .title('Rampage')
        .subtitle('Dwyane Johnson')
        .text('his impressive-looking but relatively less amusing big-screen adaptation gets it backward, reverting to the shrill save-our-cities panic that fueled such hokey 1950s classics as "Them"')
        .image(builder.CardImage.create(session, 'https://en.wikipedia.org/wiki/Rampage_(2018_film)#/media/File:Rampage_teaser_film_poster.jpg'))
        .media([
            { url: 'https://www.youtube.com/watch?v=coOKvrsmQiI' }
        ])
        .buttons([
